  ...
  const slides: CourseSlide[] = React.useMemo(
    () => [
      ...
      },
      {
        ...
        image: thirtyDayPreview.desktop || thirtyDayCourse?.heroImage || "/course/30days_desktop.svg",
        imageMobile: thirtyDayPreview.mobile || thirtyDayCourse?.mobileImage || "/course/30days_mobile.svg",
